...
void _activeTripSerialize(
  ...
  writer.writeString(offsets[2], object.lastAcceptedPointJson);
  writer.writeLong(offsets[3], object.profileId);
  writer.writeLong(offsets[4], object.protocolId);
  writer.writeLong(offsets[5], object.startMileage);
  writer.writeDateTime(offsets[6], object.startTime);
  writer.writeString(offsets[7], object.trackingPointsJson);
  writer.writeDateTime(offsets[8], object.updatedAt);
  writer.writeLong(offsets[9], object.vehicleId);
}
...
ActiveTrip _activeTripDeserialize(
  ...
  object.id = id;
  object.lastAcceptedPointJson = reader.readStringOrNull(offsets[2]);
  object.profileId = reader.readLong(offsets[3]);
  object.protocolId = reader.readLong(offsets[4]);
  object.startMileage = reader.readLong(offsets[5]);
  object.startTime = reader.readDateTime(offsets[6]);
  object.trackingPointsJson = reader.readString(offsets[7]);
  object.updatedAt = reader.readDateTime(offsets[8]);
  object.vehicleId = reader.readLong(offsets[9]);
  return object;
}
