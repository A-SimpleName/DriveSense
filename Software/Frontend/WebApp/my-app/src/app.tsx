...
// speichert den aktuellen Pfad bevor zum Login weitergeleitet wird
function SaveAndRedirect({ to }: { to: string }) {
            ...
            <Routes>
                ...
                {!isAuth && (
                    <>
                        ...
                        <Route path="*" element={<SaveAndRedirect to="/login" />} />
                    </>
                )}
                        ...
                        element={
                            <SelectProfilePage
                                ...
                                onSelect={() => {
                                    ...
                                    // nach Profilauswahl pendingRedirect prüfen
